...
public class PagingTag extends TagSupport {
	...
	public String getPaging() {
		 ...
		 * 나누어 떨어지지 않으면 나머지 레코드를 출력할 페이지 가 필요하다는 의미.
		 */
		...
		if (prevLast > 0) {
			ret += " <a href=\"javascript:goPage('" + prevLast	+ "');\"><span><img src='/resources/images/common/btn_paginate_prev.gif' alt='이전' /></span></a> ";
		} else {
